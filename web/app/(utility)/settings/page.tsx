...
const TOUR_GUIDE_STEPS = [
  ...
  { target: "tour-complete", title: "4 / 4  —  Complete", desc: "When you are ready, click here to test and launch DeepHSCode." },
];
      ...
      <div className="mx-auto max-w-[960px] px-6 py-8">
          ...
          <div className="mb-6 flex items-center justify-between rounded-xl border border-[var(--primary)]/20 bg-[var(--primary)]/5 px-5 py-4">
            <div>
              ...
              <p className="mt-1 text-[13px] text-[var(--muted-foreground)]">
                {t("Configure your endpoints below, run tests, then launch DeepHSCode.")}
              </p>
            </div>
            <button
        ...
        {isTourMode && tourCompleted && (
          <div className="mb-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-5 py-4 text-center">
            ...
            <p className="mt-1 text-[13px] text-[var(--muted-foreground)]">
              {redirectCountdown > 0
                ? t("Redirecting to DeepHSCode in {{count}}s...", { count: redirectCountdown })
                : t("Redirecting...")}
            </p>
          </div>
        )}
