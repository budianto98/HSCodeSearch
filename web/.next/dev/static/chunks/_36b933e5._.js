...
"[project]/app/(utility)/memory/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MemoryPage() {
    ...
    const { activeSessionId, language } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AppShellContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppShell"])();
    ...
    const [activeView, setActiveView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("edit");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MemoryPage.useEffect": ()=>{
            if (!toast) return;
            const timer = setTimeout({
                "MemoryPage.useEffect.timer": ()=>setToast("")
            }["MemoryPage.useEffect.timer"], 3500);
            return ({
                "MemoryPage.useEffect": ()=>clearTimeout(timer)
            })["MemoryPage.useEffect"];
        }
    }["MemoryPage.useEffect"], [
        toast
    ]);
    const loadMemory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MemoryPage.useCallback[loadMemory]": async ()=>{
            setLoading(true);
            try {
                const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/memory"));
    ...
    }["MemoryPage.useCallback[loadMemory]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MemoryPage.useEffect": ()=>{
            void loadMemory();
        }
    ...
    const saveMemory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MemoryPage.useCallback[saveMemory]": async ()=>{
            setSaving(true);
            try {
                const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/memory"), {
                    method: "PUT",
                ...
                setData(d);
                setEditors({
                    "MemoryPage.useCallback[saveMemory]": (prev)=>({
                            ...prev,
                            [activeTab]: d[activeTab] || ""
                        })
                }["MemoryPage.useCallback[saveMemory]"]);
    ...
    const refreshMemory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MemoryPage.useCallback[refreshMemory]": async ()=>{
            setRefreshing(true);
            try {
                const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/memory/refresh"), {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
    ...
    }["MemoryPage.useCallback[refreshMemory]"], [
        activeSessionId,
        language
    ]);
    const clearMemory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MemoryPage.useCallback[clearMemory]": async ()=>{
            if (!window.confirm(`Clear ${tab.label}?`)) return;
            setClearing(true);
            try {
                const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/memory/clear"), {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
                ...
                setData(d);
                setEditors({
                    "MemoryPage.useCallback[clearMemory]": (prev)=>({
                            ...prev,
                            [activeTab]: d[activeTab] || ""
                        })
                }["MemoryPage.useCallback[clearMemory]"]);
    ...
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MemoryPage.useCallback[handleKeyDown]": (e)=>{
            if ((e.metaKey || e.ctrlKey) && e.key === "s") {
                e.preventDefault();
                void saveMemory();
            }
        }
    }["MemoryPage.useCallback[handleKeyDown]"], [
        saveMemory
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    ...
                                    fileName: "[project]/app/(utility)/memory/page.tsx",
                                    lineNumber: 162,
                                    columnNumber: 13
                                }, this),
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-4 flex items-center gap-1 border-b border-[var(--border)]/50 pb-3",
                    children: TABS.map((t)=>{
                        const Icon = t.icon;
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "max-w-lg text-[12px] text-[var(--muted-foreground)]",
                            children: tab.hint
                        }, void 0, false, {
                            fileName: "[project]/app/(utility)/memory/page.tsx",
                            lineNumber: 225,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        "preview"
                                            ...
                                            className: `inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[13px] transition-colors ${activeView === v ? "bg-[var(--muted)] font-medium text-[var(--foreground)]" : "text-[var(--muted-foreground)] hover:text-[var(--foreground)]"}`,
                                            children: v === "edit" ? "Edit" : "Preview"
                                        }, v, false, {
                                            fileName: "[project]/app/(utility)/memory/page.tsx",
                                            lineNumber: 229,
                                            columnNumber: 17
                ...
                loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 250,
                    columnNumber: 11
                }, this) : activeView === "edit" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: t("Cmd+S to save · Markdown supported")
                        }, void 0, false, {
                            fileName: "[project]/app/(utility)/memory/page.tsx",
                            lineNumber: 264,
                            columnNumber: 13
                    ...
                    lineNumber: 254,
                    columnNumber: 11
                }, this) : editorValue.trim() ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: t("Refresh from a session or write directly in the editor.")
                        }, void 0, false, {
                            fileName: "[project]/app/(utility)/memory/page.tsx",
                            lineNumber: 278,
                            columnNumber: 13
...
_s(MemoryPage, "zyjNIUkXnwLtjyoKvs9x3Irw2MI=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "MemoryPage");
...
//# sourceMappingURL=_36b933e5._.js.map