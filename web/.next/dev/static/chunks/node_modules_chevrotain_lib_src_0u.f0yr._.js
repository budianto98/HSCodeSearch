...
function firstForBranching(prod) {
    ...
    return [
        ...new Set(allAlternativesFirsts.flat())
    ];
}
...
function analyzeTokenTypes(tokenTypes, options) {
    ...
    tracer("Transform Patterns", ()=>{
        ...
        allTransformedPatterns = onlyRelevantTypes.map((currType)=>{
            ...
            /* istanbul ignore else */ if (currPattern instanceof RegExp) {
    ...
    tracer("misc mapping", ()=>{
        ...
        patternIdxToLongerAltIdxArr = onlyRelevantTypes.map((clazz)=>{
            ...
            if (longerAltType) {
                const longerAltIdxArr = Array.isArray(longerAltType) ? longerAltType.map((type)=>onlyRelevantTypes.indexOf(type)) : [
    ...
    tracer("Misc Mapping #2", ()=>{
        ...
        emptyGroups = onlyRelevantTypes.reduce((acc, clazz)=>{
            const groupName = clazz.GROUP;
            if (typeof groupName === "string" && !(groupName === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$lexer_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lexer"].SKIPPED)) {
                acc[groupName] = [];
            }
            return acc;
        }, {});
...
function findDuplicatePatterns(tokenTypes) {
    ...
    let identicalPatterns = tokenTypes.map((outerType)=>{
        return tokenTypes.reduce((result, innerType)=>{
            if (outerType.PATTERN.source === innerType.PATTERN.source && !found.includes(innerType) && innerType.PATTERN !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$lexer_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lexer"].NA) {
...
function findInvalidGroupType(tokenTypes) {
    const invalidTypes = tokenTypes.filter((clazz)=>{
        ...
        return group !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$lexer_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lexer"].SKIPPED && group !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$lexer_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lexer"].NA && !(typeof group === "string");
    });
        ...
        Object.keys(lexerDefinition.modes).forEach((currModeName)=>{
            ...
            currModeValue.forEach((currTokType, currIdx)=>{
                if (currTokType === undefined) {
                    ...
                    const longerAlt = Array.isArray(currTokType.LONGER_ALT) ? currTokType.LONGER_ALT : [
                        currTokType.LONGER_ALT
                    ];
                    longerAlt.forEach((currLongerAlt)=>{
                        if (currLongerAlt !== undefined && !currModeValue.includes(currLongerAlt)) {
                            errors.push({
...
function performWarningRuntimeChecks(lexerDefinition, trackLines, lineTerminatorCharacters) {
    ...
    const concreteTokenTypes = allTokenTypes.filter((currType)=>currType[PATTERN] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$lexer_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Lexer"].NA);
...
function cloneEmptyGroups(emptyGroups) {
    ...
    groupKeys.forEach((currKey)=>{
        ...
        /* istanbul ignore else */ if (Array.isArray(currGroupValue)) {
...
function isCustomPattern(tokenType) {
    ...
    /* istanbul ignore else */ if (pattern instanceof RegExp) {
        return false;
    } else if (typeof pattern === "function") {
        // CustomPatternMatcherFunc - custom patterns do not require any transformations, only wrapping in a RegExp Like object
        return true;
...
function checkLineBreaksIssues(tokType, lineTerminatorCharCodes) {
    if (Object.hasOwn(tokType, "LINE_BREAKS")) {
        ...
        /* istanbul ignore else */ if (tokType.PATTERN instanceof RegExp) {
            try {
...
const defaultParserErrorProvider = {
    ...
    buildNoViableAltMessage ({ expectedPathsPerAlt, actual, previous, customUserDescription, ruleName }) {
        ...
        if (customUserDescription) {
            ...
            const nextValidTokenSequences = allLookAheadPaths.map((currPath)=>`[${currPath.map((currTokenType)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenLabel"])(currTokenType)).join(", ")}]`);
    ...
    buildEarlyExitMessage ({ expectedIterationPaths, actual, customUserDescription, ruleName }) {
        ...
        if (customUserDescription) {
            ...
            const nextValidTokenSequences = expectedIterationPaths.map((currPath)=>`[${currPath.map((currTokenType)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenLabel"])(currTokenType)).join(",")}]`);
...
const defaultGrammarValidatorErrorProvider = {
    ...
    buildAlternationPrefixAmbiguityError (options) {
        const pathMsg = options.prefixPath.map((currTok)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tokenLabel"])(currTok)).join(", ");
...
function lookAheadSequenceFromAlternatives(altsDefs, k) {
    const partialAlts = altsDefs.map((currAlt)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$interpreter$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["possiblePathsFrom"])([
            currAlt
        ], 1));
...
function validateGrammar(options) {
    var _a;
    const errMsgProvider = (_a = options.errMsgProvider) !== null && _a !== void 0 ? _a : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$errors_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultGrammarValidatorErrorProvider"];
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$checks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateGrammar"])(options.rules, options.tokenTypes, errMsgProvider, options.grammarName);
}
}),
...
class Recoverable {
    initRecoverable(config) {
        ...
        this.resyncFollows = {};
        this.recoveryEnabled = Object.hasOwn(config, "recoveryEnabled") ? config.recoveryEnabled // assumes end user provides the correct config value/type
    ...
    canRecoverWithSingleTokenDeletion(expectedTokType) {
        ...
        const isNextTokenWhatIsExpected = this.tokenMatcher(// not using LA_FAST because LA(2) might be un-safe with maxLookahead=1
        // in some edge cases (?)
...
function attemptInRepetitionRecovery(prodFunc, args, lookaheadFunc, dslMethodIdx, prodOccurrence, nextToksWalker, notStuck) {
    ...
    if (this.RULE_STACK_IDX === 0 && isEndOfRule && expectTokAfterLastMatch === undefined) {
...
class LLkLookaheadStrategy {
    ...
    validateNoLeftRecursion(rules) {
        return rules.flatMap((currTopRule)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$checks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateNoLeftRecursion"])(currTopRule, currTopRule, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$errors_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultGrammarValidatorErrorProvider"]));
    }
    validateEmptyOrAlternatives(rules) {
        return rules.flatMap((currTopRule)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$checks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateEmptyOrAlternative"])(currTopRule, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$errors_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultGrammarValidatorErrorProvider"]));
    }
    validateAmbiguousAlternationAlternatives(rules, maxLookahead) {
        return rules.flatMap((currTopRule)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$checks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateAmbiguousAlternationAlternatives"])(currTopRule, maxLookahead, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$errors_public$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultGrammarValidatorErrorProvider"]));
    }
...
class LooksAhead {
    initLooksAhead(config) {
        this.dynamicTokensEnabled = Object.hasOwn(config, "dynamicTokensEnabled") ? config.dynamicTokensEnabled // assumes end user provides the correct config value/type
        ...
        this.maxLookahead = Object.hasOwn(config, "maxLookahead") ? config.maxLookahead // assumes end user provides the correct config value/type
        ...
        this.lookaheadStrategy = Object.hasOwn(config, "lookaheadStrategy") ? config.lookaheadStrategy // assumes end user provides the correct config value/type
    ...
    getKeyForAutomaticLookahead(dslMethodIdx, occurrence) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$keys$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getKeyForAutomaticLookahead"])(this.currRuleShortName, dslMethodIdx, occurrence);
    }
...
class TreeBuilder {
    initTreeBuilder(config) {
        ...
        this.nodeLocationTracking = Object.hasOwn(config, "nodeLocationTracking") ? config.nodeLocationTracking // assumes end user provides the correct config value/type
    ...
    getBaseCstVisitorConstructor() {
        if (this.baseCstVisitorConstructor === undefined) {
            const newBaseCstVisitorConstructor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$cst$2f$cst_visitor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBaseSemanticVisitorConstructor"])(this.className, Object.keys(this.gastProductionsCache));
    ...
    getBaseCstVisitorConstructorWithDefaults() {
        if (this.baseCstVisitorWithDefaultsConstructor === undefined) {
            const newConstructor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$cst$2f$cst_visitor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBaseVisitorConstructorWithDefaults"])(this.className, Object.keys(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
class RecognizerApi {
    ...
    getSerializedGastProductions() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chevrotain$2f$gast$2f$lib$2f$src$2f$model$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serializeGrammar"])(Object.values(this.gastProductionsCache));
    }
}
}),
...
class RecognizerEngine {
    initRecognizerEngine(tokenVocabulary, config) {
        ...
        } else if (Object.hasOwn(tokenVocabulary, "modes") && Object.values(tokenVocabulary.modes).flat().every(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTokenType"])) {
            const allTokenTypes = Object.values(tokenVocabulary.modes).flat();
            const uniqueTokens = [
                ...new Set(allTokenTypes)
            ];
        ...
        const noTokenCategoriesUsed = allTokenTypes.every(// intentional "==" to also cover "undefined"
        (tokenConstructor)=>{
            var _a;
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$scan$2f$tokens$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["augmentTokenTypes"])(Object.values(this.tokensMap));
    }
    defineRule(ruleName, impl, config) {
        if (this.selfAnalysisDone) {
            throw Error(`Grammar rule <${ruleName}> may not be defined after the 'performSelfAnalysis' method has been called'\n` + `Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
        }
        const resyncEnabled = Object.hasOwn(config, "resyncEnabled") ? config.resyncEnabled // assumes end user provides the correct config value/type
        ...
        const recoveryValueFunc = Object.hasOwn(config, "recoveryValueFunc") ? config.recoveryValueFunc // assumes end user provides the correct config value/type
     ...
     */ onBeforeParse(ruleName) {
        ...
        for(let i = 0; i < this.maxLookahead + 1; i++){
            this.tokVector.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$parser$2f$parser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_OF_FILE"]);
        }
    }
    /**
     ...
     */ onAfterParse(ruleName) {
        ...
        while(this.tokVector.at(-1) === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$parser$2f$parser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_OF_FILE"]){
            this.tokVector.pop();
        }
    }
}
...
class ErrorHandler {
    initErrorHandler(config) {
        this._errors = [];
        this.errorMessageProvider = Object.hasOwn(config, "errorMessageProvider") ? config.errorMessageProvider // assumes end user provides the correct config value/type
...
class Parser {
            ...
            if (this.definitionErrors.length === 0) {
                ...
                if (this.recoveryEnabled) {
                    this.TRACE_INIT("computeAllProdsFollows", ()=>{
                        const allFollows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$chevrotain$2f$lib$2f$src$2f$parse$2f$grammar$2f$follow$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeAllProdsFollows"])(Object.values(this.gastProductionsCache));
    ...
    constructor(tokenVocabulary, config){
        ...
        this.skipValidations = Object.hasOwn(config, "skipValidations") ? config.skipValidations // casting assumes the end user passing the correct type
...
//# sourceMappingURL=node_modules_chevrotain_lib_src_0u.f0yr._.js.map