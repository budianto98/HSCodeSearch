...
"[project]/app/(workspace)/hscode-finder/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HSCodeFinderPage() {
    ...
    const canSend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HSCodeFinderPage.useMemo[canSend]": ()=>input.trim().length > 0 && !loading
    }["HSCodeFinderPage.useMemo[canSend]"], [
        input,
        loading
    ]);
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HSCodeFinderPage.useCallback[scrollToBottom]": ()=>{
    ...
    const handleSend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HSCodeFinderPage.useCallback[handleSend]": async ()=>{
            ...
            setError(null);
            setMessages({
                "HSCodeFinderPage.useCallback[handleSend]": (prev)=>[
                        ...prev,
                        {
                            role: "user",
                            content: safeQuery
            ...
            }["HSCodeFinderPage.useCallback[handleSend]"]);
            setLoading(true);
            scrollToBottom();
            try {
                const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/hscode/generate/stream"), {
                    method: "POST",
                    headers: {
                ...
                const appendAssistantText = {
                    "HSCodeFinderPage.useCallback[handleSend].appendAssistantText": (line)=>{
                        setMessages({
                            "HSCodeFinderPage.useCallback[handleSend].appendAssistantText": (prev)=>{
                                const next = [
                                    ...prev
                                ];
                        ...
                        }["HSCodeFinderPage.useCallback[handleSend].appendAssistantText"]);
                        scrollToBottom();
                    }
                }["HSCodeFinderPage.useCallback[handleSend].appendAssistantText"];
                ...
                while(true){
                    ...
                    for (const raw of lines){
                        ...
                        if (parsed.event === "error") {
                            const message = typeof parsed.data === "object" && parsed.data !== null && "message" in parsed.data ? String(parsed.data.message ?? "") : t("Unknown error");
                ...
                setMessages({
                    "HSCodeFinderPage.useCallback[handleSend]": (prev)=>prev.map({
                            "HSCodeFinderPage.useCallback[handleSend]": (msg, idx)=>idx === prev.length - 1 && msg.role === "assistant" && !msg.content.trim() ? {
                                    ...msg,
                                    content: t("No result was returned by SmartHSCode.")
                                } : msg
                        }["HSCodeFinderPage.useCallback[handleSend]"])
                }["HSCodeFinderPage.useCallback[handleSend]"]);
            } catch (err) {
                    ...
                    "HSCodeFinderPage.useCallback[handleSend]": (prev)=>{
                        ...
                        for(let i = next.length - 1; i >= 0; i -= 1){
                            if (next[i].role === "assistant") {
                                next[i] = {
                                    ...next[i],
                                    content: next[i].content.trim() ? `${next[i].content}\n\n${t("Error: {{message}}", {
                                        message
                                    })}` : t("Error: {{message}}", {
                                        message
                                    })
    ...
    const onComposerKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HSCodeFinderPage.useCallback[onComposerKeyDown]": (event)=>{
            if (event.key === "Enter" && !event.shiftKey) {
                event.preventDefault();
                void handleSend();
            }
        }
    }["HSCodeFinderPage.useCallback[onComposerKeyDown]"], [
        handleSend
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "border-b border-[var(--border)]/50 px-8 py-4",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        className: "text-xl font-semibold tracking-tight text-[var(--foreground)]",
                        children: t("HSCode Finder")
                    }, void 0, false, {
                        fileName: "[project]/app/(workspace)/hscode-finder/page.tsx",
                        lineNumber: 201,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "mt-1 text-sm text-[var(--muted-foreground)]",
                        children: t("Describe your product, and SmartHSCode Agent will return HS code suggestions.")
                    }, void 0, false, {
                        fileName: "[project]/app/(workspace)/hscode-finder/page.tsx",
                        lineNumber: 202,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mx-auto flex w-full max-w-5xl flex-1 flex-col px-4 pb-5 pt-4 sm:px-6 lg:px-8",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ref: listRef,
                        ...
                        children: [
                            messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mx-auto max-w-2xl rounded-2xl border border-dashed border-[var(--border)]/50 bg-[var(--background)]/70 p-6 text-center",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm text-[var(--muted-foreground)]",
                                    children: t("Start by entering a product description. Example: \"Insulated stainless steel water bottle, 750ml\".")
                                }, void 0, false, {
                                    fileName: "[project]/app/(workspace)/hscode-finder/page.tsx",
                                    lineNumber: 214,
                                    columnNumber: 15
                                ...
                                columnNumber: 13
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `max-w-[85%] rounded-2xl px-4 py-3 text-[14px] leading-relaxed shadow-sm sm:max-w-[78%] ${msg.role === "user" ? "bg-[var(--secondary)] text-[var(--foreground)]" : "border border-[var(--border)]/50 bg-[var(--background)] text-[var(--foreground)]"}`,
                            ...
                            loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "inline-flex items-center gap-2 rounded-2xl border border-[var(--border)]/60 bg-[var(--background)] px-4 py-3 text-sm text-[var(--muted-foreground)] shadow-sm",
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: t("SmartHSCode is analyzing your product...")
                                        }, void 0, false, {
                                            fileName: "[project]/app/(workspace)/hscode-finder/page.tsx",
                                            lineNumber: 238,
                                            columnNumber: 17
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-4 rounded-2xl border border-[var(--border)] bg-[var(--card)] px-4 py-3 shadow-[0_1px_8px_rgba(0,0,0,0.03)]",
                        children: [
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: error ? t("Error: {{message}}", {
                                            message: error
                                        }) : t("Connected to SmartHSCode Agent")
                                    }, void 0, false, {
                                        fileName: "[project]/app/(workspace)/hscode-finder/page.tsx",
                                        lineNumber: 256,
                                        columnNumber: 13
...
_s(HSCodeFinderPage, "LxNZwZ5jX9dI2SVNrPsDOoupEbE=", false, function() {
    return [
...
_c = HSCodeFinderPage;
var _c;
__turbopack_context__.k.register(_c, "HSCodeFinderPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_056a~yb._.js.map