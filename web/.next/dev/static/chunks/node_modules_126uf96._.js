...
function isOptionalProd(prod, alreadyVisited = []) {
    ...
    } else if (prod instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$chevrotain$2f$gast$2f$lib$2f$src$2f$model$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NonTerminal"] && alreadyVisited.includes(prod)) {
...
function buildTypeString(type) {
    if (Array.isArray(type)) {
        const typeNames = [
            ...new Set(type.map((t)=>getTypeString(t)))
        ];
...
//# sourceMappingURL=node_modules_126uf96._.js.map