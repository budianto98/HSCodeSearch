...
"[project]/app/(workspace)/hscode-finder/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HSCodeFinderPage() {
    ...
    const handleSend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        scrollToBottom();
        try {
            const response = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiUrl"])("/api/v1/hscode/generate/stream"), {
                method: "POST",
                headers: {
            ...
            const appendAssistantText = (line)=>{
                setMessages((prev)=>{
                    const next = [
                        ...prev
                    ];
            ...
            setMessages((prev)=>prev.map((msg, idx)=>idx === prev.length - 1 && msg.role === "assistant" && !msg.content.trim() ? {
                        ...msg,
    ...
    const onComposerKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__079bmeo._.js.map