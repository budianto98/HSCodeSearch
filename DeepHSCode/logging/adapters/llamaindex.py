...
Forwards LlamaIndex logs to DeepHSCode's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to DeepHSCode logger.
    """

    def __init__(self, ai_tutor_logger, add_prefix: bool = True):
        """
        Args:
            ai_tutor_logger: DeepHSCode Logger instance
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to DeepHSCode logger.
        """
        try:
