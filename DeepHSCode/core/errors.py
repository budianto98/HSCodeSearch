...
class DeepHSCodeError(Exception):
    """Base class for all application errors in DeepHSCode."""
...
class ConfigurationError(DeepHSCodeError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(DeepHSCodeError):
    """Raised when input validation fails."""

    pass


class ServiceError(DeepHSCodeError):
