...
Usage:
    from DeepHSCode.tools.reason import reason
...
async def reason(
    ...
    """
    from DeepHSCode.services.llm import complete as llm_complete, stream as llm_stream
    from DeepHSCode.services.llm.config import get_llm_config
    from DeepHSCode.services.llm import get_token_limit_kwargs
    from DeepHSCode.services.config import get_agent_params
