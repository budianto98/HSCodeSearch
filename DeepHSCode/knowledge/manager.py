...
from DeepHSCode.services.rag.factory import DEFAULT_PROVIDER, LEGACY_PROVIDER_ALIASES, normalize_provider_name
...
def _get_embedding_fingerprint() -> tuple[str, int] | None:
    ...
    try:
        from DeepHSCode.services.embedding import get_embedding_config
