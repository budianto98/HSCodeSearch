...
from DeepHSCode.services.rag.factory import DEFAULT_PROVIDER
from DeepHSCode.services.rag.pipelines.llamaindex import LlamaIndexPipeline
        ...
        for idx, doc_file in enumerate(new_files, 1):
            try:
                if self.progress_tracker is not None:
                    from DeepHSCode.knowledge.progress_tracker import ProgressStage
