...
from DeepHSCode.core.capability_protocol import BaseCapability
from DeepHSCode.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("DeepHSCode.plugins.loader")
    except Exception:
