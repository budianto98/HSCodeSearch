...
from DeepHSCode.core.tool_protocol import BaseTool, ToolDefinition, ToolPromptHints

# Built-in tools import wrapped in try/except as tools module may not exist
try:
    from DeepHSCode.tools.builtin import BUILTIN_TOOL_TYPES, TOOL_ALIASES
    from DeepHSCode.tools.prompting import ToolPromptComposer
except ImportError:
    BUILTIN_TOOL_TYPES = []
    TOOL_ALIASES = {}
    ToolPromptComposer = None
