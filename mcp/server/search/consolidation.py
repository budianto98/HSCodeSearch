...
_logger = logging.getLogger("Search.Consolidation")


def _llm_complete_sync(
    prompt: str,
    system_prompt: str,
    model: str,
    api_key: str,
    ...
    """Minimal synchronous LLM completion via an OpenAI-compatible endpoint."""
    import os

    effective_base_url = base_url or os.getenv("LLM_HOST", "https://api.openai.com/v1")
    effective_api_key = api_key or os.getenv("LLM_API_KEY", "")
    effective_model = model or os.getenv("LLM_MODEL", "gpt-4o-mini")
