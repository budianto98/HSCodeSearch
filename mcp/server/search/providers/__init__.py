...
def get_default_provider(**kwargs) -> BaseSearchProvider:
    ...
    """
    provider_name = os.getenv("SEARCH_PROVIDER", "brave").lower()
...
def _register_builtin_providers() -> None:
    # Deferred imports break the circular-import cycle:
    # each provider module does `from . import register_provider`, which requires
    # this file to be fully initialised first.
    from . import brave, duckduckgo, jina, perplexity, searxng, serper, tavily, webcrawler  # noqa: F401
